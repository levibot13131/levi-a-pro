...
describe('TwitterFormFields', () => {
  it('renders without crashing', () => {
    const mockForm = {
      ...
      reset: vi.fn(),
      control: {
        _subjects: { values: vi.fn(), array: vi.fn(), state: vi.fn() },
        _removeUnmounted: vi.fn(),
        _names: { mount: new Set(), unMount: new Set(), array: new Set(), focus: '', watchAll: false, watch: new Set() },
        ...
        _options: { mode: 'onSubmit' as const, reValidateMode: 'onChange' as const, shouldFocusError: true },
